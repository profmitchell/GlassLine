...
struct GlassLineSource {
	...
	int mode; // 0: Centered Waveform, 1: Symmetric Waveform, 2: Mirrored Bars, 3: Filled Mirror, 4: Centered Dots, 5: Multi-Wave, 6: Symetric Dots, 7: DNA Wave, 8: Pixel Bars
	uint32_t color;
